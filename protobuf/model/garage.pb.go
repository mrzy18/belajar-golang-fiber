...
const file_model_garage_proto_rawDesc = "" +
	"\n" +
	"\x12model/garage.proto\x12\x05model\"L\n" +
	...
	"\x05value\x18\x02 \x01(\v2\x11.model.GarageListR\x05value:\x028\x01B\tZ\a./modelb\x06proto3"

var (
	file_model_garage_proto_rawDescOnce sync.Once
	file_model_garage_proto_rawDescData []byte
)

func file_model_garage_proto_rawDescGZIP() []byte {
	file_model_garage_proto_rawDescOnce.Do(func() {
		file_model_garage_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_model_garage_proto_rawDesc), len(file_model_garage_proto_rawDesc)))
	})
...
func file_model_garage_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_model_garage_proto_rawDesc), len(file_model_garage_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
